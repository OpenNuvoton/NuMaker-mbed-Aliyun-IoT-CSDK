...
#if defined(__MBED__)
/* This library needs 'ssize_t' type, which doesn't define in must non-POSIX platforms.
 * 
 * On POSIX, 'ssize_t' type is defined in 'unistd.h' or 'sys/types.h'.
 * On Mbed OS, 'ssize_t' type is defined in 'platform/mbed_retarget.h'.
 */
